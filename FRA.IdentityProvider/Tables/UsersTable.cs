...
namespace FRA.IdentityProvider.Tables
{
    public class UsersTable
    {
        ...
        {
            const string command = "INSERT INTO Users (FirstName, LastName, UserName, FullName, NormalizedUserName, Email, NormalizedEmail, EmailConfirmed, PasswordHash, PhoneNumber,PhoneNumberConfirmed, PhotoUrl, Address, ConcurrencyStamp, SecurityStamp, RegistrationDate, LastLoginDate, LockoutEnabled, LockoutEndDateTimeUtc, TwoFactorEnabled, AccessFailedCount)" +
                                   "VALUES (@FirstName, @LastName, @UserName, @FullName, @NormalizedUserName, @Email, @NormalizedEmail, @EmailConfirmed, @PasswordHash, @PhoneNumber, @PhoneNumberConfirmed, @PhotoUrl, @Address, @ConcurrencyStamp, @SecurityStamp, @RegistrationDate, @LastLoginDate, @LockoutEnabled, @LockoutEndDateTimeUtc, @TwoFactorEnabled, @AccessFailedCount);";
